...
function Main() {
    ...
    {
        // abcde(); show(second(3)); show(increment()); show_figure(3);
        // math_operations(); show(plus(15, 2)); show(summ(10, 2, 5));
        // show(different(17, 10, 7)); show(HelloWorld()); show(HelloWorld2("Привет, ",
        // "Мир!")); show(YourName(prompt())); show(Your_Age(prompt())); Prompt_Name();
        // double_figure(); show(Stroka2("abcde")); show(Summ_numbers([1, 2, 3, 4, 5]));
        // show(Hour_Days_Month(3, 5, 2)); show(Now_Time()); show(massiv());
        // showMassiv(); textMassiv(); instead_Massiv(); assosiative_Massiv();
    }
